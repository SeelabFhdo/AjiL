...
/**
 * This is the item provider adapter for a {@link ajiMLT.GeneratorDescriptor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GeneratorDescriptorItemProvider 
	 ...
	 * @generated
	 */
	public GeneratorDescriptorItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		EGenerator labelValue = ((GeneratorDescriptor)object).getGenerator();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_GeneratorDescriptor_type") :
			getString("_UI_GeneratorDescriptor_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GeneratorDescriptor.class)) {
			case AjiMLTPackage.GENERATOR_DESCRIPTOR__GENERATOR:
