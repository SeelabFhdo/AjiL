...
/**
 * This is the item provider adapter for a {@link ajiML.Ability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ability_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ability_name_feature", "_UI_Ability_type"),
				 AjiMLPackage.Literals.ABILITY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addSubjectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ability_subject_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ability_subject_feature", "_UI_Ability_type"),
				 AjiMLPackage.Literals.ABILITY__SUBJECT,
				 true,
				 false,
				 true,
				 null,
