...
/**
 * This is the item provider adapter for a {@link ajiML.Create} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CreateItemProvider extends AbilityItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Create_subject_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Create_subject_feature", "_UI_Create_type"),
				 AjiMLPackage.Literals.CREATE__SUBJECT,
				 true,
				 false,
				 true,
				 null,
