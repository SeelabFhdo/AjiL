...
/**
 * This is the item provider adapter for a {@link ajiML.Delete} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeleteItemProvider extends AbilityItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Delete_subject_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Delete_subject_feature", "_UI_Delete_type"),
				 AjiMLPackage.Literals.DELETE__SUBJECT,
				 true,
				 false,
				 true,
				 null,
