...
/**
 * This is the item provider adapter for a {@link ajiML.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AjiMLPackage.Literals.ENTITY__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AjiMLPackage.Literals.ENTITY__PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AjiMLPackage.Literals.ENTITY__ATTRIBUTES);
			childrenFeatures.add(AjiMLPackage.Literals.ENTITY__RELATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AjiMLPackage.Literals.ENTITY__ATTRIBUTES,
				 AjiMLFactory.eINSTANCE.createBoolean()));

		newChildDescriptors.add
			(createChildParameter
				(AjiMLPackage.Literals.ENTITY__ATTRIBUTES,
				 AjiMLFactory.eINSTANCE.createFloat()));

		newChildDescriptors.add
			(createChildParameter
				(AjiMLPackage.Literals.ENTITY__ATTRIBUTES,
				 AjiMLFactory.eINSTANCE.createString()));
