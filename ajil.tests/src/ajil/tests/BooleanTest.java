 ...
 * @generated
 */
public class BooleanTest extends PrimitiveDataTypeTest {
	 ...
	 */
	@Override
	protected ajil.Boolean getFixture() {
		return (ajil.Boolean)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(AjilFactory.eINSTANCE.createBoolean());
	}
