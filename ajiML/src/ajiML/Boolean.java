 ...
 * </p>
 * <ul>
 *   <li>{@link ajiML.Boolean#getName <em>Name</em>}</li>
 *   <li>{@link ajiML.Boolean#getType <em>Type</em>}</li>
 * </ul>
 *
 * @see ajiML.AjiMLPackage#getBoolean()
 * @model
 * @generated
 */
public interface Boolean extends PrimitiveDataType {
	 ...
	 * @see #setName(String)
	 * @see ajiML.AjiMLPackage#getBoolean_Name()
	...
	/**
	 * Sets the value of the '{@link ajiML.Boolean#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ajiML.AjiMLPackage#getBoolean_Type()
