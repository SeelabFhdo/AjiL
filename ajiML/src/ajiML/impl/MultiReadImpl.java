 ...
 * </p>
 * <ul>
 *   <li>{@link ajiML.impl.MultiReadImpl#getSubject <em>Subject</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultiReadImpl extends AbilityImpl implements MultiRead {
	...
	protected EClass eStaticClass() {
		return AjiMLPackage.Literals.MULTI_READ;
	}
		...
		if (subject != null && subject.eIsProxy()) {
			...
			if (subject != oldSubject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AjiMLPackage.MULTI_READ__SUBJECT, oldSubject, subject));
			}
		}
		return subject;
	}
	...
	public void setSubject(Entity newSubject) {
		...
		subject = newSubject;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AjiMLPackage.MULTI_READ__SUBJECT, oldSubject, subject));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AjiMLPackage.MULTI_READ__SUBJECT:
