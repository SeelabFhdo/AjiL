 ...
 * </p>
 * <ul>
 *   <li>{@link ajiML.impl.UpdateImpl#getSubject <em>Subject</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UpdateImpl extends AbilityImpl implements Update {
	...
	protected EClass eStaticClass() {
		return AjiMLPackage.Literals.UPDATE;
	}
		...
		if (subject != null && subject.eIsProxy()) {
			...
			if (subject != oldSubject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AjiMLPackage.UPDATE__SUBJECT, oldSubject, subject));
			}
		}
		return subject;
	}
	...
	public void setSubject(Entity newSubject) {
		...
		subject = newSubject;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AjiMLPackage.UPDATE__SUBJECT, oldSubject, subject));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AjiMLPackage.UPDATE__SUBJECT:
