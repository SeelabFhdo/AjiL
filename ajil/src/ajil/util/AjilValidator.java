 ...
 * @generated
 */
public class AjilValidator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final AjilValidator INSTANCE = new AjilValidator();
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "ajil";
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			...
			case AjilPackage.SYSTEM:
				return validateSystem((ajil.System)value, diagnostics, context);
			...
			case AjilPackage.INTEGER:
				return validateInteger((ajil.Integer)value, diagnostics, context);
			case AjilPackage.BOOLEAN:
				return validateBoolean((ajil.Boolean)value, diagnostics, context);
			case AjilPackage.FLOAT:
				return validateFloat((ajil.Float)value, diagnostics, context);
			case AjilPackage.STRING:
				return validateString((ajil.String)value, diagnostics, context);
			case AjilPackage.CHAR:
				return validateChar((Char)value, diagnostics, context);
			case AjilPackage.ECOMMUNICATION_MECHANISM:
				return validateECommunicationMechanism((ECommunicationMechanism)value, diagnostics, context);
	 ...
	 * @generated
	 */
	public boolean validateSystem(ajil.System system, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateMicroservice_uniqueServiceName(Microservice microservice, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(AjilPackage.Literals.MICROSERVICE,
				 microservice,
				 diagnostics,
				 context,
	...
	public boolean validateFunctionalService_noSelfDependency(FunctionalService functionalService, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(AjilPackage.Literals.FUNCTIONAL_SERVICE,
				 functionalService,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL",
	...
	public boolean validateServiceInterface_uniqueInterfaceName(ServiceInterface serviceInterface, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(AjilPackage.Literals.SERVICE_INTERFACE,
				 serviceInterface,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL",
	...
	public boolean validateDomainModel(DomainModel domainModel, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateDomainModel_uniqueDomainName(domainModel, diagnostics, context);
		return result;
	}

	/**
	 * The cached validation expression for the uniqueDomainName constraint of '<em>Domain Model</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String DOMAIN_MODEL__UNIQUE_DOMAIN_NAME__EEXPRESSION = "DomainModel.allInstances()->forAll(d : DomainModel | d <> self implies d.name <> self.name)";

	/**
	 * Validates the uniqueDomainName constraint of '<em>Domain Model</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateDomainModel_uniqueDomainName(DomainModel domainModel, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(AjilPackage.Literals.DOMAIN_MODEL,
				 domainModel,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL",
				 "uniqueDomainName",
				 DOMAIN_MODEL__UNIQUE_DOMAIN_NAME__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
	 ...
	 * @generated
	 */
	public boolean validateInteger(ajil.Integer integer, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateBoolean(ajil.Boolean boolean_, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateFloat(ajil.Float float_, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateString(ajil.String string, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateECommunicationMechanism(ECommunicationMechanism eCommunicationMechanism, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return true;
	}
