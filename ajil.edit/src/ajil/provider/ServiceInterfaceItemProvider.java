...
/**
 * This is the item provider adapter for a {@link ajil.ServiceInterface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceInterfaceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AjilPackage.Literals.SERVICE_INTERFACE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addMechanismPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceInterface_mechanism_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceInterface_mechanism_feature", "_UI_ServiceInterface_type"),
				 AjilPackage.Literals.SERVICE_INTERFACE__MECHANISM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AjilPackage.Literals.SERVICE_INTERFACE__VERSION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AjilPackage.Literals.SERVICE_INTERFACE__EXPOSED_TO_GATEWAYS,
				 false,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AjilPackage.Literals.SERVICE_INTERFACE__ABILITIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AjilPackage.Literals.SERVICE_INTERFACE__ABILITIES,
				 AjilFactory.eINSTANCE.createCreate()));

		newChildDescriptors.add
			(createChildParameter
				(AjilPackage.Literals.SERVICE_INTERFACE__ABILITIES,
				 AjilFactory.eINSTANCE.createRead()));

		newChildDescriptors.add
			(createChildParameter
				(AjilPackage.Literals.SERVICE_INTERFACE__ABILITIES,
				 AjilFactory.eINSTANCE.createMultiRead()));

		newChildDescriptors.add
			(createChildParameter
				(AjilPackage.Literals.SERVICE_INTERFACE__ABILITIES,
				 AjilFactory.eINSTANCE.createUpdate()));

		newChildDescriptors.add
			(createChildParameter
				(AjilPackage.Literals.SERVICE_INTERFACE__ABILITIES,
				 AjilFactory.eINSTANCE.createDelete()));

		newChildDescriptors.add
			(createChildParameter
				(AjilPackage.Literals.SERVICE_INTERFACE__ABILITIES,
				 AjilFactory.eINSTANCE.createCustom()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return AjilEditPlugin.INSTANCE;
	}
